  ...
  return (
    <Container>
      {cart.products.length > 0 ? (
                  ...
                  <ProductDetail>
                    <Link
                      ...
                      aria-label={`${product.name} en ${
                        product.color
                      } unidades totales ${product.quantity} cost = ${
                        product.price * product.quantity
                      }`}
                      title={`${product.name} en ${product.color} unidades totales ${
                        product.quantity
        ...
        <SadFaceMsg text={'Tu carrito esta vacio.'} />
      )}
    </Container>
  );
};
